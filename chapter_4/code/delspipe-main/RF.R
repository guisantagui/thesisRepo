...
# iEK1011 Genome Scale Metabolic Model.                                                                 #
#                                                                                                       #
#########################################################################################################
...
rownames(delsBinRdx) <- delsBin$gene
...
linGroup <- factor(gsub("[[:digit:]]", "", gsub(".*_", "", rownames(delsBinRdx))))
