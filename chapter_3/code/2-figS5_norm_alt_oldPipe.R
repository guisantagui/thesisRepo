...
# Alteration: do imputation by KNN, as we did in the first of all the reports
missingMet <-  MissingValues(mets_parsed[, colnames(mets_parsed) != "Group"],
                             feature.cutof=0.8, sample.cutoff=0.2, method="knn")


# Use metvar function to do several statistical tests
metvarprenorm <- metvar(missingMet$featuredata,
                        mets_parsed$Group)
...
featuredataMet <- missingMet$featuredata
